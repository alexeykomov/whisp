 ...
 * @const
 */chrome.accessibilityFeatures={};/** @type {!ChromeSetting} */chrome.accessibilityFeatures.spokenFeedback;/** @type {!ChromeSetting} */chrome.accessibilityFeatures.largeCursor;/** @type {!ChromeSetting} */chrome.accessibilityFeatures.stickyKeys;/** @type {!ChromeSetting} */chrome.accessibilityFeatures.highContrast;/** @type {!ChromeSetting} */chrome.accessibilityFeatures.screenMagnifier;/** @type {!ChromeSetting} */chrome.accessibilityFeatures.autoclick;/** @type {!ChromeSetting} */chrome.accessibilityFeatures.virtualKeyboard;/** @type {!ChromeSetting} */chrome.accessibilityFeatures.animationPolicy;/**
 * @const
 * @see http://developer.chrome.com/apps/app.runtime.html
 */chrome.app.runtime={};/**
 * @constructor
 * @see http://developer.chrome.com/apps/app_runtime.html
 */chrome.app.runtime.LaunchItem=function(){};/** @type {!FileEntry} */chrome.app.runtime.LaunchItem.prototype.entry;/** @type {string} */chrome.app.runtime.LaunchItem.prototype.type;/** @type {!ChromeObjectEvent} */chrome.app.runtime.onLaunched;/**
 * @type {!ChromeEvent}
 ...
 *     other windows.
 * @see http://developer.chrome.com/apps/app.window.html#type-AppWindow
 */chrome.app.window.AppWindow.prototype.setAlwaysOnTop=function(alwaysOnTop){};/** @type {!ChromeEvent} */chrome.app.window.AppWindow.prototype.onBoundsChanged;/** @type {!ChromeEvent} */chrome.app.window.AppWindow.prototype.onClosed;/** @type {!ChromeEvent} */chrome.app.window.AppWindow.prototype.onFullscreened;/** @type {!ChromeEvent} */chrome.app.window.AppWindow.prototype.onMinimized;/** @type {!ChromeEvent} */chrome.app.window.AppWindow.prototype.onMaximized;/** @type {!ChromeEvent} */chrome.app.window.AppWindow.prototype.onRestored;/** @type {!Window} */chrome.app.window.AppWindow.prototype.contentWindow;/**
 * @typedef {?{
 *   left: number,
 *   top: number,
 *   width: number,
 ...
 *     Callback to be run.
 * @see http://developer.chrome.com/apps/app.window.html#method-create
 */chrome.app.window.create=function(url,opt_options,opt_createWindowCallback){};/**
 ...
 * }}
 */chrome.audioModem.RequestParams;/** @constructor */chrome.audioModem.ReceivedToken=function(){};/** @type {!ArrayBuffer} */chrome.audioModem.ReceivedToken.prototype.token;/** @type {string} */chrome.audioModem.ReceivedToken.prototype.band;/**
 ...
 * @param {string} band
 * @param {function(string)} callback
 */chrome.audioModem.stopReceive=function(band,callback){};/** @constructor */chrome.audioModem.ReceivedEvent=function(){};/**
 ...
 * @param {function(!Array<!chrome.audioModem.ReceivedToken>)} callback
 */chrome.audioModem.ReceivedEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!Array<!chrome.audioModem.ReceivedToken>)} callback
 * @return {boolean}
 */chrome.audioModem.ReceivedEvent.prototype.hasListener=function(callback){};/**
 * @return {boolean}
 */chrome.audioModem.ReceivedEvent.prototype.hasListeners=function(){};/** @type {!chrome.audioModem.ReceivedEvent} */chrome.audioModem.onReceived;/** @type {!ChromeStringEvent} */chrome.audioModem.onTransmitFail;/**
 * @const
 ...
 * @constructor
 */chrome.bluetooth.AdapterStateEvent=function(){};/** @param {function(!chrome.bluetooth.AdapterState): void} callback */chrome.bluetooth.AdapterStateEvent.prototype.addListener=function(callback){};/** @param {function(!chrome.bluetooth.AdapterState): void} callback */chrome.bluetooth.AdapterStateEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.bluetooth.AdapterState): void} callback
 * @return {boolean}
 */chrome.bluetooth.AdapterStateEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetooth.AdapterStateEvent.prototype.hasListeners=function(){};/**
 ...
 * @constructor
 */chrome.bluetooth.DeviceEvent=function(){};/** @param {function(!chrome.bluetooth.Device): void} callback */chrome.bluetooth.DeviceEvent.prototype.addListener=function(callback){};/** @param {function(!chrome.bluetooth.Device): void} callback */chrome.bluetooth.DeviceEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.bluetooth.Device): void} callback
 * @return {boolean}
 */chrome.bluetooth.DeviceEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetooth.DeviceEvent.prototype.hasListeners=function(){};/**
 ...
 */chrome.bluetoothSocket.listenUsingRfcomm=function(socketId,uuid,optionsOrCallback,opt_callback){};/**
 * @param {number} socketId
 * @param {string} uuid
 * @param {!chrome.bluetoothSocket.ListenOptions|function()} optionsOrCallback
 * @param {function()=} opt_callback
 * @see https://developer.chrome.com/apps/bluetoothSocket#method-listenUsingL2cap
 */chrome.bluetoothSocket.listenUsingL2cap=function(socketId,uuid,optionsOrCallback,opt_callback){};/**
 * @param {number} socketId
 ...
 */chrome.bluetoothSocket.AcceptEventData=function(){};/** @type {number} */chrome.bluetoothSocket.AcceptEventData.prototype.socketId;/** @type {number} */chrome.bluetoothSocket.AcceptEventData.prototype.clientSocketId;/**
 ...
 */chrome.bluetoothSocket.AcceptEvent.prototype.addListener=function(callback){};/**
 * @param {function(!chrome.bluetoothSocket.AcceptEventData): void} callback
 */chrome.bluetoothSocket.AcceptEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.bluetoothSocket.AcceptEventData): void} callback
 * @return {boolean}
 */chrome.bluetoothSocket.AcceptEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetoothSocket.AcceptEvent.prototype.hasListeners=function(){};/** @type {!chrome.bluetoothSocket.AcceptEvent} */chrome.bluetoothSocket.onAccept;/**
 * @constructor
 * @see https://developer.chrome.com/apps/bluetoothSocket#event-onAcceptError
 */chrome.bluetoothSocket.AcceptErrorEventData=function(){};/** @type {number} */chrome.bluetoothSocket.AcceptErrorEventData.prototype.socketId;/** @type {string} */chrome.bluetoothSocket.AcceptErrorEventData.prototype.errorMessage;/** @type {string} */chrome.bluetoothSocket.AcceptErrorEventData.prototype.error;/**
 ...
 */chrome.bluetoothSocket.AcceptErrorEvent.prototype.addListener=function(callback){};/**
 * @param {function(
 *     !chrome.bluetoothSocket.AcceptErrorEventData): void} callback
 */chrome.bluetoothSocket.AcceptErrorEvent.prototype.removeListener=function(callback){};/**
 * @param {function(
 *     !chrome.bluetoothSocket.AcceptErrorEventData): void} callback
 * @return {boolean}
 */chrome.bluetoothSocket.AcceptErrorEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetoothSocket.AcceptErrorEvent.prototype.hasListeners=function(){};/** @type {!chrome.bluetoothSocket.AcceptErrorEvent} */chrome.bluetoothSocket.onAcceptError;/**
 * @constructor
 * @see https://developer.chrome.com/apps/bluetoothSocket#event-onReceive
 */chrome.bluetoothSocket.ReceiveEventData=function(){};/** @type {number} */chrome.bluetoothSocket.ReceiveEventData.prototype.socketId;/** @type {!ArrayBuffer} */chrome.bluetoothSocket.ReceiveEventData.prototype.data;/**
 ...
 */chrome.bluetoothSocket.ReceiveEvent.prototype.addListener=function(callback){};/**
 * @param {function(!chrome.bluetoothSocket.ReceiveEventData): void} callback
 */chrome.bluetoothSocket.ReceiveEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.bluetoothSocket.ReceiveEventData): void} callback
 * @return {boolean}
 */chrome.bluetoothSocket.ReceiveEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetoothSocket.ReceiveEvent.prototype.hasListeners=function(){};/** @type {!chrome.bluetoothSocket.ReceiveEvent} */chrome.bluetoothSocket.onReceive;/**
 * @constructor
 * @see https://developer.chrome.com/apps/bluetoothSocket#event-onReceiveError
 */chrome.bluetoothSocket.ReceiveErrorEventData=function(){};/** @type {number} */chrome.bluetoothSocket.ReceiveErrorEventData.prototype.socketId;/** @type {string} */chrome.bluetoothSocket.ReceiveErrorEventData.prototype.errorMessage;/** @type {string} */chrome.bluetoothSocket.ReceiveErrorEventData.prototype.error;/**
 ...
 */chrome.bluetoothSocket.ReceiveErrorEvent.prototype.addListener=function(callback){};/**
 * @param {function(
 *     !chrome.bluetoothSocket.ReceiveErrorEventData): void} callback
 */chrome.bluetoothSocket.ReceiveErrorEvent.prototype.removeListener=function(callback){};/**
 * @param {function(
 *     !chrome.bluetoothSocket.ReceiveErrorEventData): void} callback
 * @return {boolean}
 */chrome.bluetoothSocket.ReceiveErrorEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetoothSocket.ReceiveErrorEvent.prototype.hasListeners=function(){};/** @type {!chrome.bluetoothSocket.ReceiveErrorEvent} */chrome.bluetoothSocket.onReceiveError;/**
 ...
 */chrome.bluetoothLowEnergy.Service=function(){};/** @type {string} */chrome.bluetoothLowEnergy.Service.prototype.uuid;/** @type {boolean} */chrome.bluetoothLowEnergy.Service.prototype.isPrimary;/** @type {string|undefined} */chrome.bluetoothLowEnergy.Service.prototype.instanceId;/** @type {string|undefined} */chrome.bluetoothLowEnergy.Service.prototype.deviceAddress;/**
 * @constructor
 * @see https://developer.chrome.com/apps/bluetoothLowEnergy#type-Characteristic
 */chrome.bluetoothLowEnergy.Characteristic=function(){};/** @type {string} */chrome.bluetoothLowEnergy.Characteristic.prototype.uuid;/** @type {!chrome.bluetoothLowEnergy.Service} */chrome.bluetoothLowEnergy.Characteristic.prototype.service;/** @type {!Array<string>} */chrome.bluetoothLowEnergy.Characteristic.prototype.properties;/** @type {string|undefined} */chrome.bluetoothLowEnergy.Characteristic.prototype.instanceId;/** @type {!ArrayBuffer|undefined} */chrome.bluetoothLowEnergy.Characteristic.prototype.value;/**
 * @constructor
 * @see https://developer.chrome.com/apps/bluetoothLowEnergy#type-Descriptor
 */chrome.bluetoothLowEnergy.Descriptor=function(){};/** @type {string} */chrome.bluetoothLowEnergy.Descriptor.prototype.uuid;/** @type {!chrome.bluetoothLowEnergy.Characteristic} */chrome.bluetoothLowEnergy.Descriptor.prototype.characteristic;/** @type {string|undefined} */chrome.bluetoothLowEnergy.Descriptor.prototype.instanceId;/** @type {!ArrayBuffer|undefined} */chrome.bluetoothLowEnergy.Descriptor.prototype.value;/**
 * @typedef {?{
 *   persistent: boolean
 * }}
 ...
 */chrome.bluetoothLowEnergy.connect=function(deviceAddress,propertiesOrCallback,opt_callback){};/**
 * @param {string} deviceAddress
 * @param {function()=} opt_callback
 ...
 */chrome.bluetoothLowEnergy.getCharacteristic=function(characteristicId,callback){};/**
 * @param {string} serviceId
 ...
 */chrome.bluetoothLowEnergy.getIncludedServices=function(serviceId,callback){};/**
 ...
 */chrome.bluetoothLowEnergy.getDescriptors=function(characteristicId,callback){};/**
 * @param {string} characteristicId
 * @param {function(!chrome.bluetoothLowEnergy.Characteristic)} callback
 * @see https://developer.chrome.com/apps/bluetoothLowEnergy#method-readCharacteristicValue
 */chrome.bluetoothLowEnergy.readCharacteristicValue=function(characteristicId,callback){};/**
 * @param {string} characteristicId
 * @param {!ArrayBuffer} value
 * @param {function()} callback
 * @see https://developer.chrome.com/apps/bluetoothLowEnergy#method-writeCharacteristicValue
 */chrome.bluetoothLowEnergy.writeCharacteristicValue=function(characteristicId,value,callback){};/**
 * @typedef {?{
 *   persistent: boolean
 * }}
 */chrome.bluetoothLowEnergy.NotificationSessionProperties;/**
  ...
  */chrome.bluetoothLowEnergy.startCharacteristicNotifications=function(characteristicId,propertiesOrCallback,opt_callback){};/**
  * @param {string} characteristicId
  * @param {function()=} opt_callback
  * @see https://developer.chrome.com/apps/bluetoothLowEnergy#method-stopCharacteristicNotifications
  */chrome.bluetoothLowEnergy.stopCharacteristicNotifications=function(characteristicId,opt_callback){};/**
 * @param {string} descriptorId
 * @param {function(!chrome.bluetoothLowEnergy.Descriptor)} callback
 * @see https://developer.chrome.com/apps/bluetoothLowEnergy#method-readDescriptorValue
 */chrome.bluetoothLowEnergy.readDescriptorValue=function(descriptorId,callback){};/**
 * @param {string} descriptorId
 * @param {!ArrayBuffer} value
 * @param {function()} callback
 * @see https://developer.chrome.com/apps/bluetoothLowEnergy#method-writeDescriptorValue
 */chrome.bluetoothLowEnergy.writeDescriptorValue=function(descriptorId,value,callback){};/**
 * Event whose listeners take a Service parameter.
 * @constructor
 */chrome.bluetoothLowEnergy.ServiceEvent=function(){};/** @param {function(!chrome.bluetoothLowEnergy.Service): void} callback */chrome.bluetoothLowEnergy.ServiceEvent.prototype.addListener=function(callback){};/** @param {function(!chrome.bluetoothLowEnergy.Service): void} callback */chrome.bluetoothLowEnergy.ServiceEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.bluetoothLowEnergy.Service): void} callback
 * @return {boolean}
 */chrome.bluetoothLowEnergy.ServiceEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetoothLowEnergy.ServiceEvent.prototype.hasListeners=function(){};/**
 ...
 *     callback
 */chrome.bluetoothLowEnergy.CharacteristicEvent.prototype.addListener=function(callback){};/**
 * @param {function(!chrome.bluetoothLowEnergy.Characteristic): void}
 *     callback
 */chrome.bluetoothLowEnergy.CharacteristicEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.bluetoothLowEnergy.Characteristic): void}
 *     callback
 * @return {boolean}
 */chrome.bluetoothLowEnergy.CharacteristicEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetoothLowEnergy.CharacteristicEvent.prototype.hasListeners=function(){};/**
 ...
 *     callback
 */chrome.bluetoothLowEnergy.DescriptorEvent.prototype.addListener=function(callback){};/**
 * @param {function(!chrome.bluetoothLowEnergy.Descriptor): void}
 *     callback
 */chrome.bluetoothLowEnergy.DescriptorEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.bluetoothLowEnergy.Descriptor): void} callback
 * @return {boolean}
 */chrome.bluetoothLowEnergy.DescriptorEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetoothLowEnergy.DescriptorEvent.prototype.hasListeners=function(){};/**
 ...
 */chrome.commands.getAll=function(callback){};/** @type {!ChromeEvent} */chrome.commands.onCommand;/**
 ...
 */chrome.copresence.PublishOperation;/** @typedef {?{type: string}} */chrome.copresence.SubscriptionFilter;/**
 * @typedef {?{
 *   id: string,
 ...
 */chrome.copresence.MessagesReceivedEvent.prototype.addListener=function(callback){};/**
 * @param {function(string, !Array<!chrome.copresence.Message>): void} callback
 */chrome.copresence.MessagesReceivedEvent.prototype.removeListener=function(callback){};/**
 * @param {function(string, !Array<!chrome.copresence.Message>): void} callback
 * @return {boolean}
 */chrome.copresence.MessagesReceivedEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.copresence.MessagesReceivedEvent.prototype.hasListeners=function(){};/**
 ...
 *     finished.
 */chrome.enterprise.platformKeys.importCertificate=function(tokenId,certificate,opt_callback){};/**
 * @param {string} tokenId The id of a Token returned by getTokens.
 * @param {!ArrayBuffer} certificate The DER encoding of a X.509 certificate.
 * @param {(function(): void)=} opt_callback Called back when this operation is
 *     finished.
 */chrome.enterprise.platformKeys.removeCertificate=function(tokenId,certificate,opt_callback){};/**
 * @see https://developer.chrome.com/extensions/extension.html
 * @const
 */chrome.extension={};/** @type {!Object|undefined} */chrome.extension.lastError={};/**
 * @type {string|undefined}
 */chrome.extension.lastError.message;/** @type {boolean|undefined} */chrome.extension.inIncognitoContext;// TODO: change Object to !Object when it's clear nobody is passing in null
 ...
 */chrome.extension.connect=function(opt_extensionIdOrConnectInfo,opt_connectInfo){};/**
 ...
 */chrome.extension.sendMessage=function(extensionIdOrRequest,opt_request,opt_callback){};/**
 ...
 * as needed.
 * @constructor
 */chrome.runtime.Manifest=function(){};/** @type {string} */chrome.runtime.Manifest.prototype.name;/** @type {string} */chrome.runtime.Manifest.prototype.version;/** @type {number|undefined} */chrome.runtime.Manifest.prototype.manifest_version;/** @type {string|undefined} */chrome.runtime.Manifest.prototype.description;/** @type {!chrome.runtime.Manifest.Oauth2|undefined} */chrome.runtime.Manifest.prototype.oauth2;/** @type {!Array<(string|!Object)>} */chrome.runtime.Manifest.prototype.permissions;/**
 * Oauth2 info in the manifest.
 * See http://developer.chrome.com/apps/app_identity.html#update_manifest.
 * @constructor
 */chrome.runtime.Manifest.Oauth2=function(){};/** @type {string} */chrome.runtime.Manifest.Oauth2.prototype.client_id;/**@type {!Array<string>} */chrome.runtime.Manifest.Oauth2.prototype.scopes;/**
 ...
 *     captured tab.
 */chrome.tabs.captureVisibleTab=function(windowIdOrOptionsOrCallback,opt_optionsOrCallback,opt_callback){};/**
 ...
 *     injected frame.
 */chrome.tabs.executeScript=function(tabIdOrDetails,opt_detailsOrCallback,opt_callback){};/**
 * @param {number} tabId Tab id.
 ...
 */chrome.tabs.insertCSS=function(tabIdOrDetails,opt_detailsOrCallback,opt_callback){};/**
 * @typedef {?{
 *   windowId: (number|undefined),
 *   index: number
 * }}
 ...
 *     reload is complete.
 */chrome.tabs.reload=function(opt_tabIdOrReloadPropertiesOrCallback,opt_reloadPropertiesOrCallback,opt_callback){};/**
 ...
 */chrome.tabs.update=function(tabIdOrUpdateProperties,opt_updatePropertiesOrCallback,opt_callback){};/**
 * @type {!ChromeEvent}
 * @deprecated Please use tabs.onActivated.
 */chrome.tabs.onActiveChanged;/** @type {!ChromeEvent} */chrome.tabs.onActivated;/** @type {!ChromeEvent} */chrome.tabs.onAttached;/** @type {!ChromeEvent} */chrome.tabs.onCreated;/** @type {!ChromeEvent} */chrome.tabs.onDetached;/**
 * @type {!ChromeEvent}
 * @deprecated Please use tabs.onHighlighted.
 */chrome.tabs.onHighlightChanged;/**
 * @type {!ChromeEvent}
 */chrome.tabs.onHighlighted;/** @type {!ChromeEvent} */chrome.tabs.onMoved;/** @type {!ChromeEvent} */chrome.tabs.onRemoved;/** @type {!ChromeEvent} */chrome.tabs.onUpdated;/** @type {!ChromeEvent} */chrome.tabs.onReplaced;// DEPRECATED:
 ...
 */chrome.topSites.MostVisitedURL=function(){};/** @type {string} */chrome.topSites.MostVisitedURL.prototype.url;/** @type {string} */chrome.topSites.MostVisitedURL.prototype.title;/**
 ...
 *     various options.
 * @param {function(): void=} opt_callback Callback.
 */chrome.windows.update=function(tabId,updateProperties,opt_callback){};/** @type {!ChromeEvent} */chrome.windows.onCreated;/** @type {!ChromeEvent} */chrome.windows.onFocusChanged;/** @type {!ChromeEvent} */chrome.windows.onRemoved;/**
 ...
 * @param {number} tabId Tab Id.
 */chrome.pageAction.show=function(tabId){};/** @type {!ChromeEvent} */chrome.pageAction.onClicked;/**
 * @const
 ...
 */chrome.browserAction.BrowserActionTabEvent.prototype.addListener=function(callback){};/**
 * @param {function(!Tab): void} callback
 */chrome.browserAction.BrowserActionTabEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!Tab): void} callback
 * @return {boolean}
 */chrome.browserAction.BrowserActionTabEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.browserAction.BrowserActionTabEvent.prototype.hasListeners=function(){};/**
 ...
 */chrome.omnibox={};/** @constructor */chrome.omnibox.InputChangedEvent=function(){};/**
 ...
 * @param {function(string, function(!Array<!SuggestResult>)): void} callback
 */chrome.omnibox.InputChangedEvent.prototype.removeListener=function(callback){};/**
 * @param {function(string, function(!Array<!SuggestResult>)): void} callback
 * @return {boolean}
 */chrome.omnibox.InputChangedEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.omnibox.InputChangedEvent.prototype.hasListeners=function(){};/** @constructor */chrome.omnibox.InputEnteredEvent=function(){};/** @param {function(string, string): void} callback */chrome.omnibox.InputEnteredEvent.prototype.addListener=function(callback){};/** @param {function(string, string): void} callback */chrome.omnibox.InputEnteredEvent.prototype.removeListener=function(callback){};/**
 * @param {function(string, string): void} callback
 * @return {boolean}
 */chrome.omnibox.InputEnteredEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.omnibox.InputEnteredEvent.prototype.hasListeners=function(){};/**
 * @param {{description: string}} suggestion A partial SuggestResult object.
 */chrome.omnibox.setDefaultSuggestion=function(suggestion){};/** @type {!ChromeEvent} */chrome.omnibox.onInputCancelled;/** @type {!chrome.omnibox.InputChangedEvent} */chrome.omnibox.onInputChanged;/** @type {!chrome.omnibox.InputEnteredEvent} */chrome.omnibox.onInputEntered;/** @type {!ChromeEvent} */chrome.omnibox.onInputStarted;/**
 * @const
 ...
 * @param {function(!Object, !Tab=)} callback
 */chrome.contextMenus.ClickedEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!Object, !Tab=)} callback
 * @return {boolean}
 ...
 * @type {!ChromeEvent}
 */chrome.cookies.onChanged;/** @constructor */function CookieChangeInfo(){}/** @type {boolean} */CookieChangeInfo.prototype.removed;/** @type {Cookie} */CookieChangeInfo.prototype.cookie;/** @type {string} */CookieChangeInfo.prototype.cause;/** @const */chrome.management={};/**
 * @typedef {?{
 ...
 * @param {function(!Array<string>)=} opt_callback Optional callback function.
 */chrome.management.getPermissionWarningsByManifest=function(manifestStr,opt_callback){};/**
 * @param {string} id The id of an already installed extension.
 ...
 *     callback function.
 * @param {function(): void=} opt_callback Optional callback function.
 */chrome.management.uninstall=function(id,opt_optionsOrCallback,opt_callback){};/**
 * @param {(!chrome.management.InstallOptions|function(): void)=}
 *     opt_optionsOrCallback An optional uninstall options object or an optional
 *     callback function.
 * @param {function(): void=} opt_callback An optional callback function.
 */chrome.management.uninstallSelf=function(opt_optionsOrCallback,opt_callback){};/**
 * @param {string} id The id of an already installed extension.
 * @param {function(): void=} opt_callback Optional callback function.
 ...
 * @param {function(!ExtensionInfo): void=} opt_callback Optional callback
 *     function.
 */chrome.management.generateAppForLink=function(url,title,opt_callback){};/** @type {!ChromeExtensionInfoEvent} */chrome.management.onDisabled;/** @type {!ChromeExtensionInfoEvent} */chrome.management.onEnabled;/** @type {!ChromeExtensionInfoEvent} */chrome.management.onInstalled;/** @type {!ChromeStringEvent} */chrome.management.onUninstalled;/**
 * @const
 ...
 */chrome.idle.setDetectionInterval=function(intervalInSeconds){};/** @type {!ChromeEvent} */chrome.idle.onStateChanged;/**
 ...
 * @constructor
 */function TtsEvent(){}/** @type {string} */TtsEvent.prototype.type;/** @type {number} */TtsEvent.prototype.charIndex;/** @type {string} */TtsEvent.prototype.errorMessage;/**
 * A description of a voice available for speech synthesis.
 * @constructor
 */function TtsVoice(){}/** @type {string} */TtsVoice.prototype.voiceName;/** @type {string} */TtsVoice.prototype.lang;/** @type {string} */TtsVoice.prototype.gender;/** @type {string} */TtsVoice.prototype.extensionId;/** @type {Array<string>} */TtsVoice.prototype.eventTypes;/**
 ...
 */chrome.ttsEngine={};/** @type {!ChromeEvent} */chrome.ttsEngine.onSpeak;/** @type {!ChromeEvent} */chrome.ttsEngine.onStop;/**
 * @const
 * @see https://developer.chrome.com/extensions/contentSettings.html
 */chrome.contentSettings={};/** @type {!ContentSetting} */chrome.contentSettings.cookies;/** @type {!ContentSetting} */chrome.contentSettings.images;/** @type {!ContentSetting} */chrome.contentSettings.javascript;/** @type {!ContentSetting} */chrome.contentSettings.plugins;/** @type {!ContentSetting} */chrome.contentSettings.popups;/** @type {!ContentSetting} */chrome.contentSettings.notifications;/**
 * @const
 ...
 */chrome.fileBrowserHandler.ExecuteEvent.prototype.addListener=function(callback){};/**
 * @param {function(string, !FileHandlerExecuteEventDetails)} callback
 */chrome.fileBrowserHandler.ExecuteEvent.prototype.removeListener=function(callback){};/**
 * @param {function(string, !FileHandlerExecuteEventDetails)} callback
 * @return {boolean}
 */chrome.fileBrowserHandler.ExecuteEvent.prototype.hasListener=function(callback){};/**
 * @return {boolean}
 ...
 */chrome.history.search=function(query,callback){};/** @type {!ChromeEvent} */chrome.history.onVisitRemoved;/** @type {!ChromeEvent} */chrome.history.onVisited;/**
 * @const
 ...
 *     are specified.
 */chrome.identity.getAuthToken=function(detailsOrCallback,opt_callback){};/** @typedef {{interactive: (boolean|undefined)}} */chrome.identity.TokenDetails;/**
 * @param {chrome.identity.InvalidTokenDetails} details
 * @param {function(): void} callback
 */chrome.identity.removeCachedAuthToken=function(details,callback){};/** @typedef {{token: string}} */chrome.identity.InvalidTokenDetails;/**
 * @param {chrome.identity.WebAuthFlowDetails} details
 * @param {function(string=): void} callback
 */chrome.identity.launchWebAuthFlow=function(details,callback){};/** @typedef {{url: string, interactive: (boolean|undefined)}} */chrome.identity.WebAuthFlowDetails;/** @param {function(!Object):void} callback */chrome.identity.getProfileUserInfo=function(callback){};/** @type {!ChromeEvent} */chrome.identity.onSignInChanged;/**
 * @const
 * @see https://developer.chrome.com/extensions/input.ime.html
 */chrome.input={};/** @const */chrome.input.ime={};/**
 ...
 */ChromeInputImeOnKeyEventEvent.prototype.addListener=function(callback,opt_extraInfoSpec){};/**
 * @param {function(string, !ChromeKeyboardEvent): (boolean|undefined)} callback
 *     callback.
 ...
 *     (Object) keys.
 * @param {function(boolean): void=} opt_callback Callback function.
 */chrome.input.ime.setCandidateWindowProperties=function(parameters,opt_callback){};/**
 ...
 */chrome.mediaGalleries.getMediaFileSystems=function(detailsOrCallback,opt_callback){};/**
 ...
 */chrome.mediaGalleries.dropPermissionForMediaFileSystem=function(galleryId,opt_callback){};chrome.mediaGalleries.startMediaScan=function(){};chrome.mediaGalleries.cancelMediaScan=function(){};/**
 ...
 * }}
 */chrome.mediaGalleries.MetaData;/** @const */chrome.mediaGalleries.metadata={};/** @constructor */chrome.mediaGalleries.metadata.RawTag=function(){};/** @type {string} */chrome.mediaGalleries.metadata.RawTag.prototype.type;/** @type {!Object<string, string>} */chrome.mediaGalleries.metadata.RawTag.prototype.tags;/**
 ...
 */chrome.mediaGalleries.getMetadata=function(mediaFile,optionsOrCallback,opt_callback){};/**
 ...
 */chrome.mediaGalleries.getAllGalleryWatch=function(callback){};chrome.mediaGalleries.removeAllGalleryWatch=function(){};/**
 * @constructor
 ...
 */chrome.mediaGalleries.GalleryChangeEvent.prototype.addListener=function(callback){};/**
 * @param {!chrome.mediaGalleries.GalleryChangeCallback} callback
 */chrome.mediaGalleries.GalleryChangeEvent.prototype.removeListener=function(callback){};/**
 * @param {!chrome.mediaGalleries.GalleryChangeCallback} callback
 */chrome.mediaGalleries.GalleryChangeEvent.prototype.hasListener=function(callback){};/**
 * @return {boolean}
 ...
 * parameter.
 * @constructor
 */chrome.mediaGalleries.ScanProgressEvent=function(){};/** @param {function(!chrome.mediaGalleries.OnScanProgressDetails)} callback */chrome.mediaGalleries.ScanProgressEvent.prototype.addListener=function(callback){};/** @param {function(!chrome.mediaGalleries.OnScanProgressDetails)} callback */chrome.mediaGalleries.ScanProgressEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.mediaGalleries.OnScanProgressDetails)} callback
 * @return {boolean}
 */chrome.mediaGalleries.ScanProgressEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.mediaGalleries.ScanProgressEvent.prototype.hasListeners=function(){};/** @type {!chrome.mediaGalleries.ScanProgressEvent} */chrome.mediaGalleries.onScanProgress;/**
 * @const
 ...
 * @param {!chrome.permissions.Permissions} permissions
 * @param {function(boolean): void=} opt_callback Callback function.
 */chrome.permissions.request=function(permissions,opt_callback){};/** @type {!ChromeEvent} */chrome.permissions.onAdded;/** @type {!ChromeEvent} */chrome.permissions.onRemoved;/**
 ...
 */chrome.privacy={};/** @type {!Object<string,!ChromeSetting>} */chrome.privacy.network;/** @type {!Object<string,!ChromeSetting>} */chrome.privacy.services;/** @type {!Object<string,!ChromeSetting>} */chrome.privacy.websites;/**
 * @const
 * @see https://developer.chrome.com/extensions/proxy.html
 */chrome.proxy={};/** @type {!Object<string,!ChromeSetting>} */chrome.proxy.settings;/** @type {!ChromeEvent} */chrome.proxy.onProxyError;/**
 * @const
 * @see http://developer.chrome.com/apps/socket.html
 */chrome.socket={};/**
 * @constructor
 */chrome.socket.CreateInfo=function(){};/** @type {number} */chrome.socket.CreateInfo.prototype.socketId;/**
 * @constructor
 */chrome.socket.ReadInfo=function(){};/** @type {number} */chrome.socket.ReadInfo.prototype.resultCode;/** @type {!ArrayBuffer} */chrome.socket.ReadInfo.prototype.data;/**
 * @constructor
 */chrome.socket.WriteInfo=function(){};/** @type {number} */chrome.socket.WriteInfo.prototype.bytesWritten;/**
 * @constructor
 */chrome.socket.RecvFromInfo=function(){};/** @type {number} */chrome.socket.RecvFromInfo.prototype.resultCode;/** @type {!ArrayBuffer} */chrome.socket.RecvFromInfo.prototype.data;/** @type {string} */chrome.socket.RecvFromInfo.prototype.address;/** @type {number} */chrome.socket.RecvFromInfo.prototype.port;/**
 * @constructor
 */chrome.socket.AcceptInfo=function(){};/** @type {number} */chrome.socket.AcceptInfo.prototype.resultCode;/** @type {(number|undefined)} */chrome.socket.AcceptInfo.prototype.socketId;/**
 * @constructor
 */chrome.socket.SocketInfo=function(){};/** @type {string} */chrome.socket.SocketInfo.prototype.socketType;/** @type {boolean} */chrome.socket.SocketInfo.prototype.connected;/** @type {(string|undefined)} */chrome.socket.SocketInfo.prototype.peerAddress;/** @type {(number|undefined)} */chrome.socket.SocketInfo.prototype.peerPort;/** @type {(string|undefined)} */chrome.socket.SocketInfo.prototype.localAddress;/** @type {(number|undefined)} */chrome.socket.SocketInfo.prototype.localPort;/**
 * @constructor
 */chrome.socket.NetworkAdapterInfo=function(){};/** @type {string} */chrome.socket.NetworkAdapterInfo.prototype.name;/** @type {string} */chrome.socket.NetworkAdapterInfo.prototype.address;/**
 ...
 *     that was available to be read without blocking.
 */chrome.socket.recvFrom=function(socketId,bufferSizeOrCallback,opt_callback){};/**
 * @param {number} socketId The id of the socket to write to.
 * @param {!ArrayBuffer} data The data to write.
 ...
 *     completes.
 */chrome.socket.listen=function(socketId,address,port,backlogOrCallback,opt_callback){};/**
 ...
 *     is complete.
 */chrome.socket.setKeepAlive=function(socketId,enable,delayOrCallback,opt_callback){};/**
 * @param {number} socketId The id of the socket to listen on.
 ...
 * @param {function(number)} callback Called when the configuration operation is
 *     done.
 */chrome.socket.setMulticastLoopbackMode=function(socketId,enabled,callback){};/**
 * @param {number} socketId The id of the socket.
 ...
 */chrome.sockets.tcp.setKeepAlive=function(socketId,enable,delayOrCallback,opt_callback){};/**
 * @param {number} socketId
 ...
 */chrome.sockets.tcp.connect=function(socketId,peerAddress,peerPort,callback){};/**
 * @param {number} socketId The id of the socket to disconnect.
 * @param {function()=} opt_callback
 ...
 * @param {function(number)=} opt_callback
 * @see https://developer.chrome.com/apps/sockets_tcp#method-secure
 */chrome.sockets.tcp.secure=function(socketId,optionsOrCallback,opt_callback){};/**
 * @param {number} socketId
 * @param {!ArrayBuffer} data
 * @param {function(!Object)} callback
 ...
 */chrome.sockets.tcp.ReceiveEventData=function(){};/** @type {number} */chrome.sockets.tcp.ReceiveEventData.prototype.socketId;/** @type {!ArrayBuffer} */chrome.sockets.tcp.ReceiveEventData.prototype.data;/**
 * Event whose listeners take a ReceiveEventData parameter.
 * @constructor
 */chrome.sockets.tcp.ReceiveEvent=function(){};/**
 * @param {function(!chrome.sockets.tcp.ReceiveEventData): void} callback
 */chrome.sockets.tcp.ReceiveEvent.prototype.addListener=function(callback){};/**
 * @param {function(!chrome.sockets.tcp.ReceiveEventData): void} callback
 */chrome.sockets.tcp.ReceiveEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.sockets.tcp.ReceiveEventData): void} callback
 * @return {boolean}
 */chrome.sockets.tcp.ReceiveEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.sockets.tcp.ReceiveEvent.prototype.hasListeners=function(){};/** @type {!chrome.sockets.tcp.ReceiveEvent} */chrome.sockets.tcp.onReceive;/**
 * @constructor
 * @see https://developer.chrome.com/apps/sockets_tcp#event-onReceiveError
 */chrome.sockets.tcp.ReceiveErrorEventData=function(){};/** @type {number} */chrome.sockets.tcp.ReceiveErrorEventData.prototype.socketId;/** @type {number} */chrome.sockets.tcp.ReceiveErrorEventData.prototype.resultCode;/**
 * Event whose listeners take a ReceiveErrorEventData parameter.
 * @constructor
 */chrome.sockets.tcp.ReceiveErrorEvent=function(){};/**
 * @param {function(
 *     !chrome.sockets.tcp.ReceiveErrorEventData): void} callback
 */chrome.sockets.tcp.ReceiveErrorEvent.prototype.addListener=function(callback){};/**
 * @param {function(
 *     !chrome.sockets.tcp.ReceiveErrorEventData): void} callback
 */chrome.sockets.tcp.ReceiveErrorEvent.prototype.removeListener=function(callback){};/**
 * @param {function(
 *     !chrome.sockets.tcp.ReceiveErrorEventData): void} callback
 * @return {boolean}
 */chrome.sockets.tcp.ReceiveErrorEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.sockets.tcp.ReceiveErrorEvent.prototype.hasListeners=function(){};/** @type {!chrome.sockets.tcp.ReceiveErrorEvent} */chrome.sockets.tcp.onReceiveError;/**
 * @const
 * @see https://developer.chrome.com/extensions/storage.html
 */chrome.storage={};/** @type {!StorageArea} */chrome.storage.sync;/** @type {!StorageArea} */chrome.storage.local;/** @type {!StorageChangeEvent} */chrome.storage.onChanged;/** @const */chrome.system={};/**
 * @const
 ...
 */chrome.system.display={};/** @type {!ChromeEvent} */chrome.system.display.onDisplayChanged;/**
 * @constructor
 */chrome.system.display.Bounds=function(){};/** @type {number} */chrome.system.display.Bounds.prototype.left;/** @type {number} */chrome.system.display.Bounds.prototype.top;/** @type {number} */chrome.system.display.Bounds.prototype.width;/** @type {number} */chrome.system.display.Bounds.prototype.height;/**
 * @typedef {{
 *   left: (number|undefined),
 *   top: (number|undefined),
 ...
 * @constructor
 */chrome.system.display.DisplayInfo=function(){};/** @type {string} */chrome.system.display.DisplayInfo.prototype.id;/** @type {string} */chrome.system.display.DisplayInfo.prototype.name;/** @type {string} */chrome.system.display.DisplayInfo.prototype.mirroringSourceId;/** @type {boolean} */chrome.system.display.DisplayInfo.prototype.isPrimary;/** @type {boolean} */chrome.system.display.DisplayInfo.prototype.isInternal;/** @type {boolean} */chrome.system.display.DisplayInfo.prototype.isEnabled;/** @type {number} */chrome.system.display.DisplayInfo.prototype.dpiX;/** @type {number} */chrome.system.display.DisplayInfo.prototype.dpiY;/** @type {number} */chrome.system.display.DisplayInfo.prototype.rotation;/** @type {!chrome.system.display.Bounds} */chrome.system.display.DisplayInfo.prototype.bounds;/** @type {!chrome.system.display.Insets} */chrome.system.display.DisplayInfo.prototype.overscan;/** @type {!chrome.system.display.Bounds} */chrome.system.display.DisplayInfo.prototype.workArea;/**
 * @typedef {{
 ...
 * }}
 */chrome.system.display.SettableDisplayInfo;chrome.types={};/**
 * @typedef {?{
 ...
 */chrome.system.display.setDisplayProperties=function(id,info,opt_callback){};/**
 * @const
 * @see https://developer.chrome.com/extensions/types.html
 */chrome.chromeSetting={};/** @type {!ChromeEvent} */chrome.chromeSetting.onChange;/**
 * @const
 ...
 */WebRequestEvent.prototype.addListener=function(listener,filter,opt_extraInfoSpec){};/**
 * @param {function(!Object): (void|!BlockingResponse)} listener Listener
 *     function.
 ...
 * @param {!RequestFilter} filter A set of filters that restrict
 *     the events that will be sent to this listener.
 */WebRequestOnErrorOccurredEvent.prototype.addListener=function(listener,filter){};/**
 * @param {function(!Object): void} listener Listener function.
 ...
 */chrome.webRequest={};/**
 * @param {function(): void=} opt_callback Callback function.
 */chrome.webRequest.handlerBehaviorChanged=function(opt_callback){};/** @type {!WebRequestEvent} */chrome.webRequest.onAuthRequired;/** @type {!WebRequestEvent} */chrome.webRequest.onBeforeRedirect;/** @type {!WebRequestEvent} */chrome.webRequest.onBeforeRequest;/** @type {!WebRequestEvent} */chrome.webRequest.onBeforeSendHeaders;/** @type {!WebRequestEvent} */chrome.webRequest.onCompleted;/** @type {!WebRequestOnErrorOccurredEvent} */chrome.webRequest.onErrorOccurred;/** @type {!WebRequestEvent} */chrome.webRequest.onHeadersReceived;/** @type {!WebRequestEvent} */chrome.webRequest.onResponseStarted;/** @type {!WebRequestEvent} */chrome.webRequest.onSendHeaders;// Classes
/**
 * @see https://developer.chrome.com/extensions/management.html
 * @constructor
 */function ExtensionInfo(){}/** @type {string} */ExtensionInfo.prototype.id;/** @type {string} */ExtensionInfo.prototype.name;/** @type {string} */ExtensionInfo.prototype.shortName;/** @type {string} */ExtensionInfo.prototype.description;/** @type {string} */ExtensionInfo.prototype.version;/** @type {boolean} */ExtensionInfo.prototype.mayDisable;/** @type {boolean} */ExtensionInfo.prototype.enabled;/** @type {string|undefined} */ExtensionInfo.prototype.disabledReason;/** @type {boolean} */ExtensionInfo.prototype.isApp;/** @type {string} */ExtensionInfo.prototype.type;/** @type {string|undefined} */ExtensionInfo.prototype.appLaunchUrl;/** @type {string|undefined} */ExtensionInfo.prototype.homepageUrl;/** @type {string|undefined} */ExtensionInfo.prototype.updateUrl;/** @type {boolean} */ExtensionInfo.prototype.offlineEnabled;/** @type {string} */ExtensionInfo.prototype.optionsUrl;/** @type {!Array<!IconInfo>|undefined} */ExtensionInfo.prototype.icons;/** @type {!Array<string>} */ExtensionInfo.prototype.permissions;/** @type {!Array<string>} */ExtensionInfo.prototype.hostPermissions;/** @type {string} */ExtensionInfo.prototype.installType;/** @type {string|undefined} */ExtensionInfo.prototype.launchType;/** @type {!Array<string>|undefined} */ExtensionInfo.prototype.availableLaunchTypes;/**
 * @see https://developer.chrome.com/extensions/management.html
 * @constructor
 */function IconInfo(){}/** @type {number} */IconInfo.prototype.size;/** @type {string} */IconInfo.prototype.url;/**
 * @see https://developer.chrome.com/extensions/windows.html
 * @constructor
 */function ChromeWindow(){}/** @type {number} */ChromeWindow.prototype.id;/** @type {boolean} */ChromeWindow.prototype.focused;/** @type {number} */ChromeWindow.prototype.top;/** @type {number} */ChromeWindow.prototype.left;/** @type {number} */ChromeWindow.prototype.width;/** @type {number} */ChromeWindow.prototype.height;/** @type {Array<Tab>} */ChromeWindow.prototype.tabs;/** @type {boolean} */ChromeWindow.prototype.incognito;/** @type {string} */ChromeWindow.prototype.type;/** @type {string} */ChromeWindow.prototype.state;/** @type {boolean} */ChromeWindow.prototype.alwaysOnTop;/**
 * Event whose listeners take an ExtensionInfo parameter.
 * @constructor
 */function ChromeExtensionInfoEvent(){}/** @param {function(!ExtensionInfo): void} callback */ChromeExtensionInfoEvent.prototype.addListener=function(callback){};/** @param {function(!ExtensionInfo): void} callback */ChromeExtensionInfoEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!ExtensionInfo): void} callback
 * @return {boolean}
 */ChromeExtensionInfoEvent.prototype.hasListener=function(callback){};/** @return {boolean} */ChromeExtensionInfoEvent.prototype.hasListeners=function(){};/**
 ...
 *     Callback.
 */chrome.pushMessaging.getChannelId=function(interactiveOrCallback,opt_callback){};/**
 ...
 */chrome.pushMessaging.PushMessageEvent.prototype.addListener=function(callback){};/**
 * @param {function(!chrome.pushMessaging.Message): void} callback
 */chrome.pushMessaging.PushMessageEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.pushMessaging.Message): void} callback
 * @return {boolean}
 */chrome.pushMessaging.PushMessageEvent.prototype.hasListener=function(callback){};/**
 * @return {boolean}
 ...
 * @constructor
 */function HistoryItem(){}/** @type {string} */HistoryItem.prototype.id;/** @type {string} */HistoryItem.prototype.url;/** @type {string} */HistoryItem.prototype.title;/** @type {number} */HistoryItem.prototype.lastVisitTime;/** @type {number} */HistoryItem.prototype.visitCount;/** @type {number} */HistoryItem.prototype.typedCount;/**
 * @see https://developer.chrome.com/extensions/history.html#type-VisitItem
 * @constructor
 */function VisitItem(){}/** @type {string} */VisitItem.prototype.id;/** @type {string} */VisitItem.prototype.visitId;/** @type {number} */VisitItem.prototype.visitTime;/** @type {string} */VisitItem.prototype.referringVisitId;/** @type {string} */VisitItem.prototype.transition;/**
 * @see https://developer.chrome.com/extensions/fileBrowserHandler.html#type-FileHandlerExecuteEventDetails
 * @constructor
 */function FileHandlerExecuteEventDetails(){}/** @type {!Array<!FileEntry>} */FileHandlerExecuteEventDetails.prototype.entries;/** @type {number|undefined} */FileHandlerExecuteEventDetails.prototype.tab_id;/**
 * @see https://developer.chrome.com/extensions/input.ime.html#type-KeyboardEvent
 * @constructor
 */function ChromeKeyboardEvent(){}/** @type {string} */ChromeKeyboardEvent.prototype.type;/** @type {string} */ChromeKeyboardEvent.prototype.requestId;/** @type {string|undefined} */ChromeKeyboardEvent.prototype.extensionId;/** @type {string} */ChromeKeyboardEvent.prototype.key;/** @type {string} */ChromeKeyboardEvent.prototype.code;/** @type {number|undefined} */ChromeKeyboardEvent.prototype.keyCode;/** @type {boolean|undefined} */ChromeKeyboardEvent.prototype.altKey;/** @type {boolean|undefined} */ChromeKeyboardEvent.prototype.ctrlKey;/** @type {boolean|undefined} */ChromeKeyboardEvent.prototype.shiftKey;/** @type {boolean|undefined} */ChromeKeyboardEvent.prototype.capsLock;/**
 * @see https://developer.chrome.com/extensions/input.ime.html#type-InputContext
 * @constructor
 */function InputContext(){}/** @type {number} */InputContext.prototype.contextID;/** @type {string} */InputContext.prototype.type;/**
 * @see https://developer.chrome.com/extensions/proxy.html#type-ProxyServer
 * @constructor
 */function ProxyServer(){}/** @type {string} */ProxyServer.prototype.scheme;/** @type {string} */ProxyServer.prototype.host;/** @type {number} */ProxyServer.prototype.port;/**
 * @see https://developer.chrome.com/extensions/proxy.html#type-ProxyRules
 * @constructor
 */function ProxyRules(){}/** @type {ProxyServer} */ProxyRules.prototype.singleProxy;/** @type {ProxyServer} */ProxyRules.prototype.proxyForHttp;/** @type {ProxyServer} */ProxyRules.prototype.proxyForHttps;/** @type {ProxyServer} */ProxyRules.prototype.proxyForFtp;/** @type {ProxyServer} */ProxyRules.prototype.fallbackProxy;/** @type {!Array<string>} */ProxyRules.prototype.bypassList;/**
 * @see https://developer.chrome.com/extensions/proxy.html#type-PacScript
 * @constructor
 */function PacScript(){}/** @type {string} */PacScript.prototype.url;/** @type {string} */PacScript.prototype.data;/** @type {boolean} */PacScript.prototype.mandatory;/**
 * @see https://developer.chrome.com/extensions/proxy.html#type-ProxyConfig
 * @constructor
 */function ProxyConfig(){}/** @type {ProxyRules} */ProxyConfig.prototype.rules;/** @type {PacScript} */ProxyConfig.prototype.pacScript;/** @type {string} */ProxyConfig.prototype.mode;/**
 ...
 *    are for.
 */StorageChangeEvent.prototype.addListener=function(callback){};/** @param {function(!Object<string, !StorageChange>, string)} callback */StorageChangeEvent.prototype.removeListener=function(callback){};/** @param {function(!Object<string, !StorageChange>, string)} callback */StorageChangeEvent.prototype.hasListener=function(callback){};/** @param {function(!Object<string, !StorageChange>, string)} callback */StorageChangeEvent.prototype.hasListeners=function(callback){};/**
 * @see https://developer.chrome.com/extensions/storage.html#type-StorageChange
 * @constructor
 */function StorageChange(){}/** @type {?} */StorageChange.prototype.oldValue;/** @type {?} */StorageChange.prototype.newValue;/**
 ...
 *     'scope' (string) key.
 * @param {function(): void=} opt_callback Callback function.
 */ChromeSetting.prototype.set=function(details,opt_callback){};/** @type {!ChromeObjectEvent} */ChromeSetting.prototype.onChange;/**
 * @see https://developer.chrome.com/extensions/webRequest.html#type-RequestFilter
 * @constructor
 */function RequestFilter(){}/** @type {!Array<string>} */RequestFilter.prototype.urls;/** @type {!Array<string>} */RequestFilter.prototype.types;/** @type {number} */RequestFilter.prototype.tabId;/** @type {number} */RequestFilter.prototype.windowId;/**
 * @see https://developer.chrome.com/extensions/webRequest.html#type-HttpHeaders
 * @constructor
 */function HttpHeader(){}/** @type {string} */HttpHeader.prototype.name;/** @type {string} */HttpHeader.prototype.value;/** @type {!Array<number>} */HttpHeader.prototype.binaryValue;/**
 * @see https://developer.chrome.com/extensions/webRequest.html#type-HttpHeaders
 ...
 * @constructor
 */function BlockingResponse(){}/** @type {boolean} */BlockingResponse.prototype.cancel;/** @type {string} */BlockingResponse.prototype.redirectUrl;/** @type {!HttpHeaders_} */BlockingResponse.prototype.requestHeaders;/** @type {!HttpHeaders_} */BlockingResponse.prototype.responseHeaders;/** @type {Object<string,string>} */BlockingResponse.prototype.authCredentials;/**
 ...
 * @constructor
 */chrome.fileSystem.Volume=function(){};/** @type {string} */chrome.fileSystem.Volume.prototype.volumeId;/** @type {boolean} */chrome.fileSystem.Volume.prototype.writable;/**
 ...
 */chrome.syncFileSystem.setConflictResolutionPolicy=function(policy,opt_callback){};/**
 ...
 *     received report.
 */chrome.hid.receiveFeatureReport=function(connectionId,reportId,size,callback){};/**
 ...
 * @param {function()} callback The callback to invoke once the write is
 *     finished.
 */chrome.hid.sendFeatureReport=function(connectionId,reportId,data,callback){};/**
 ...
 * @see http://developer.chrome.com/extensions/notifications.html#method-update
 */chrome.notifications.update=function(notificationId,options,opt_callback){};/**
 * @param {string} notificationId
 * @param {!chrome.notifications.BooleanCallback=} opt_callback
 * @see http://developer.chrome.com/extensions/notifications.html#method-clear
 ...
 * @param {!chrome.notifications.ClosedCallback} callback
 */chrome.notifications.ClosedEvent.prototype.removeListener=function(callback){};/**
 * @param {!chrome.notifications.ClosedCallback} callback
 * @return {boolean}
 ...
 */chrome.notifications.ButtonClickedEvent.prototype.addListener=function(callback){};/**
 * @param {!chrome.notifications.ButtonCallback} callback
 */chrome.notifications.ButtonClickedEvent.prototype.removeListener=function(callback){};/**
 * @param {!chrome.notifications.ButtonCallback} callback
 * @return {boolean}
 */chrome.notifications.ButtonClickedEvent.prototype.hasListener=function(callback){};/**
 * @return {boolean}
 ...
 */chrome.system.storage={};/** @constructor */chrome.system.storage.StorageUnitInfo=function(){};/** @type {string} */chrome.system.storage.StorageUnitInfo.id;/** @type {string} */chrome.system.storage.StorageUnitInfo.name;/** @type {string} Any of 'fixed', 'removable', or 'unknown' */chrome.system.storage.StorageUnitInfo.type;/** @type {number} */chrome.system.storage.StorageUnitInfo.capacity;/**
 * Event whose listeners take a StorageUnitInfoEvent parameter.
 * @constructor
 */chrome.system.storage.StorageUnitInfoEvent=function(){};/** @param {function(!chrome.system.storage.StorageUnitInfo): void} callback */chrome.system.storage.StorageUnitInfoEvent.prototype.addListener=function(callback){};/** @param {function(!chrome.system.storage.StorageUnitInfo): void} callback */chrome.system.storage.StorageUnitInfoEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.system.storage.StorageUnitInfo): void} callback
 * @return {boolean}
 */chrome.system.storage.StorageUnitInfoEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.system.storage.StorageUnitInfoEvent.prototype.hasListeners=function(){};/** @type {chrome.system.storage.StorageUnitInfoEvent} */chrome.system.storage.onAttached;/** @type {!ChromeStringEvent} */chrome.system.storage.onDetached;/**
 ...
 * @const
 */chrome.usb={};/** @constructor */chrome.usb.Device=function Device(){};/** @type {number} */chrome.usb.Device.prototype.device;/** @type {number} */chrome.usb.Device.prototype.vendorId;/** @type {number} */chrome.usb.Device.prototype.productId;/** @constructor */chrome.usb.ConnectionHandle=function ConnectionHandle(){};/** @type {number} */chrome.usb.ConnectionHandle.prototype.handle;/** @type {number} */chrome.usb.ConnectionHandle.prototype.vendorId;/** @type {number} */chrome.usb.ConnectionHandle.prototype.productId;/**
 * @typedef {?{
 *   direction: string,
 *   endpoint: number,
 ...
 *   data: (!ArrayBuffer|undefined)
 * }}
 */chrome.usb.ControlTransferInfo;/** @constructor */chrome.usb.TransferResultInfo=function(){};/** @type {number|undefined} */chrome.usb.TransferResultInfo.prototype.resultCode;/** @type {!ArrayBuffer|undefined} */chrome.usb.TransferResultInfo.prototype.data;/**
 * @typedef {?{
 *   deviceId: number,
 *   productId: number,
 ...
 *     setting is set.
 */chrome.usb.setInterfaceAlternateSetting=function(handle,interfaceNumber,alternateSetting,callback){};/**
...
/////////////////////////// Chrome Private APIs ////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
/** @const */chrome.screenlockPrivate={};/**
 ...
 */chrome.screenlockPrivate.setLocked=function(locked){};/** @type {!ChromeBooleanEvent} */chrome.screenlockPrivate.onChanged;/**
 * @const
 ...
 */chrome.mediaGalleriesPrivate.DeviceEvent.prototype.addListener=function(callback){};/**
 * @param {!chrome.mediaGalleriesPrivate.DeviceCallback} callback
 * @deprecated Use {chrome.system.storage.DeviceEvent.removeListener}.
 */chrome.mediaGalleriesPrivate.DeviceEvent.prototype.removeListener=function(callback){};/**
 * @param {!chrome.mediaGalleriesPrivate.DeviceCallback} callback
 * @deprecated Use {chrome.system.storage.DeviceEvent.hasListener}.
 */chrome.mediaGalleriesPrivate.DeviceEvent.prototype.hasListener=function(callback){};/**
 * @return {boolean}
 * @deprecated Use {chrome.system.storage.DeviceEvent.hasListener}
 */chrome.mediaGalleriesPrivate.DeviceEvent.prototype.hasListeners=function(callback){};/**
 * @interface
 ...
 */chrome.mediaGalleriesPrivate.GalleryChangeEvent.prototype.addListener=function(callback){};/**
 * @param {!chrome.mediaGalleriesPrivate.GalleryChangeCallback} callback
 */chrome.mediaGalleriesPrivate.GalleryChangeEvent.prototype.removeListener=function(callback){};/**
 * @param {!chrome.mediaGalleriesPrivate.GalleryChangeCallback} callback
 */chrome.mediaGalleriesPrivate.GalleryChangeEvent.prototype.hasListener=function(callback){};/**
 * @return {boolean}
 */chrome.mediaGalleriesPrivate.GalleryChangeEvent.prototype.hasListeners=function(){};/**
 ...
 * @param {function()=} opt_callback
 */chrome.networkingPrivate.setProperties=function(guid,properties,opt_callback){};/**
 * TODO: Use NetworkConfigProperties for |properties| once fully
 * defined.
 ...
 *     configuration.
 */chrome.networkingPrivate.createNetwork=function(shared,properties,opt_callback){};/**
 * @param {string} guid
 ...
 *     callback
 */chrome.networkingPrivate.getDeviceStates=function(callback){};/** @param {string} networkType */chrome.networkingPrivate.enableNetworkType=function(networkType){};/** @param {string} networkType */chrome.networkingPrivate.disableNetworkType=function(networkType){};/**
 ...
 * @param {function()=} opt_callback
 */chrome.networkingPrivate.startActivate=function(guid,opt_carrierOrCallback,opt_callback){};/**
 * @param {!chrome.networkingPrivate.VerificationProperties} verificationInfo
 * @param {function(boolean)} callback
 */chrome.networkingPrivate.verifyDestination=function(verificationInfo,callback){};/**
 * @param {!chrome.networkingPrivate.VerificationProperties} verificationInfo
 * @param {string} guid
 * @param {function(string)} callback
 */chrome.networkingPrivate.verifyAndEncryptCredentials=function(verificationInfo,guid,callback){};/**
 * @param {!chrome.networkingPrivate.VerificationProperties} verificationInfo
 * @param {string} data
 * @param {function(string)} callback
 */chrome.networkingPrivate.verifyAndEncryptData=function(verificationInfo,data,callback){};/**
 * @param {string} ipOrMacAddress
 * @param {boolean} enabled
 * @param {function(string)=} opt_callback
 */chrome.networkingPrivate.setWifiTDLSEnabledState=function(ipOrMacAddress,enabled,opt_callback){};/**
 * @param {string} ipOrMacAddress
 * @param {function(string)} callback
 */chrome.networkingPrivate.getWifiTDLSStatus=function(ipOrMacAddress,callback){};/**
 * @param {string} guid
 * @param {function(string)} callback
 */chrome.networkingPrivate.getCaptivePortalStatus=function(guid,callback){};/** @type {!ChromeStringArrayEvent} */chrome.networkingPrivate.onNetworksChanged;/** @type {!ChromeStringArrayEvent} */chrome.networkingPrivate.onNetworkListChanged;/** @type {!ChromeEvent} */chrome.networkingPrivate.onDeviceStateListChanged;/** @type {!ChromeStringStringEvent} */chrome.networkingPrivate.onPortalDetectionCompleted;/**
 ...
 * @constructor
 */chrome.mdns.MdnsService=function(){};/** @type {string} */chrome.mdns.MdnsService.prototype.serviceName;/** @type {string} */chrome.mdns.MdnsService.prototype.serviceHostPort;/** @type {string} */chrome.mdns.MdnsService.prototype.ipAddress;/** @type {!Array<string>} */chrome.mdns.MdnsService.prototype.serviceData;/**
 ...
 */chrome.mdns.ServiceListEvent.prototype.addListener=function(callback,opt_filter){};/** @param {function(!Array<!chrome.mdns.MdnsService>): void} callback */chrome.mdns.ServiceListEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!Array<!chrome.mdns.MdnsService>): void} callback
 * @return {boolean}
 */chrome.mdns.ServiceListEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.mdns.ServiceListEvent.prototype.hasListeners=function(){};/** @type {!chrome.mdns.ServiceListEvent} */chrome.mdns.onServiceList;/** @param {function()} callback */chrome.mdns.forceDiscovery=function(callback){};/**
 * @const
 ...
 * @param {function(!Object): void} callback  The result callback.
 */chrome.gcdPrivate.insertCommand=function(deviceId,expireInMs,command,callback){};/**
 ...
 */chrome.gcdPrivate.getCommandsList=function(deviceId,byUser,state,callback){};/**
 * Event whose listeners take a chrome.gcdPrivate.Device.
 * @constructor
 */chrome.gcdPrivate.DeviceEvent=function(){};/** @param {function(!chrome.gcdPrivate.Device): void} callback */chrome.gcdPrivate.DeviceEvent.prototype.addListener=function(callback){};/** @param {function(!chrome.gcdPrivate.Device): void} callback */chrome.gcdPrivate.DeviceEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.gcdPrivate.Device): void} callback
 * @return {boolean}
 */chrome.gcdPrivate.DeviceEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.gcdPrivate.DeviceEvent.prototype.hasListeners=function(){};/**
 ...
 * @constructor
 */chrome.bluetoothPrivate.PairingEventEvent=function(){};/** @param {function(!chrome.bluetoothPrivate.PairingEvent): void} callback */chrome.bluetoothPrivate.PairingEventEvent.prototype.addListener=function(callback){};/** @param {function(!chrome.bluetoothPrivate.PairingEvent): void} callback */chrome.bluetoothPrivate.PairingEventEvent.prototype.removeListener=function(callback){};/**
 * @param {function(!chrome.bluetoothPrivate.PairingEvent): void} callback
 * @return {boolean}
 */chrome.bluetoothPrivate.PairingEventEvent.prototype.hasListener=function(callback){};/** @return {boolean} */chrome.bluetoothPrivate.PairingEventEvent.prototype.hasListeners=function(){};/** @type {!chrome.bluetoothPrivate.PairingEventEvent} */chrome.bluetoothPrivate.onPairing;/**
 * @const
